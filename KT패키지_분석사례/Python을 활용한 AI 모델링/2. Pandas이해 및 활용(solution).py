...
#cust.groupby(['sex_type', 'cust_class']).mean()[['r3m_avg_bill_amt']]
...
#pd.concat([df1, df2], axis =0) #위와 같다
pd.concat([df1, df2], axis =1) #컬럼 레벨로 데이터를 합친다
...
# 일치하는 값이 있는 경우에만 데이터프레임을 병합하기 때문에
